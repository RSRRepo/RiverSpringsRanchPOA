...
function populateDocumentView(record) {
  ...
  openPdf.href = record.pdf;

  const downloadPdf = document.getElementById("download-pdf");
  downloadPdf.href = record.pdf;
  downloadPdf.setAttribute("download", record.pdf.split("/").pop());

  const odt = document.getElementById("download-odt");
  odt.href = record.odt;
  odt.setAttribute("download", record.odt.split("/").pop());
