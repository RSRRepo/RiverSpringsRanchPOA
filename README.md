...
## Version 1 document actions

Each SOP document page now contains:

- **Open PDF** — opens the selected PDF in a separate browser tab.
- **Download PDF** — downloads the selected PDF file.
- **Download ODT** — downloads the editable ODT source file.

The former **Print Document** button and its JavaScript have been removed. Users may print using the browser PDF viewer after selecting **Open PDF**.
